...
<div class="w3-quarter w3-container w3-center-align" >
대출기간<br/>
<input class="w3-input w3-border w3-light-gray w3-right-align" type="text" size="10" value="2년">
</div>
<div class="w3-quarter w3-container w3-center-align" >
전세금대비 대출비율<br/>
<input class="w3-input w3-border w3-light-gray w3-right-align" type="text" size="10" value="33.3%">
</div>
</div>
<br>
